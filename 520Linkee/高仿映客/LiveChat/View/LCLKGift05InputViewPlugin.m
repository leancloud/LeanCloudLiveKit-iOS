...
#import "LCLKGift05InputViewPlugin.h"
static NSString *const LCLKGiftName = @"保时捷.gif";

@implementation LCLKGift05InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType005;
}
