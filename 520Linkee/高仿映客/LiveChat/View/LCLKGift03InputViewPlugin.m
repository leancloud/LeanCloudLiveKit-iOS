...
#import "LCLKGift03InputViewPlugin.h"

static NSString *const LCLKGiftName = @"ship@2x.png";

@implementation LCLKGift03InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType003;
}
