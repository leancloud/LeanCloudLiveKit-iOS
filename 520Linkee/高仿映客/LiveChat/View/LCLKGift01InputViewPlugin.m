//
//  LCLKGift01InputViewPlugin.m
//  高仿映客
//
//  Created by 陈宜龙 on 16/9/2.
//  Copyright © 2016年 JIAAIR. All rights reserved.
//

#import "LCLKGift01InputViewPlugin.h"
#import "LCLKLiveGiftMessage.h"

static NSString *const LCLKGiftName = @"bomber.gif";

@implementation LCLKGift01InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType01;
}
...
- (UIImage *)pluginIconImage {
    return [UIImage imageNamed:@"bomber.gif"];
}
