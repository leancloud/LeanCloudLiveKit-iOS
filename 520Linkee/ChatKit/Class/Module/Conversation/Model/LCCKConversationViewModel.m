...
//  LCCKChatExample
//
//  v0.7.10 Created by ElonChan (微信向我报BUG:chenyilong1010) ( https://github.com/leancloud/ChatKit-OC ) on 15/11/18.
...
- (void)sendMessage:(id)aMessage
    ...
    if (![aMessage lcck_isCustomMessage]) {
        ...
        message.ownerType = LCCKMessageOwnerTypeOther;
