...
#import "LCLKGift08InputViewPlugin.h"
static NSString *const LCLKGiftName = @"plane.png";

@implementation LCLKGift08InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType008;
}
