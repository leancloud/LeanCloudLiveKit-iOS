...
#import "LCLKGift04InputViewPlugin.h"
static NSString *const LCLKGiftName = @"tinyCar.png";

@implementation LCLKGift04InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType004;
}
