...
#import "LCLKGift06InputViewPlugin.h"
static NSString *const LCLKGiftName = @"法拉利.gif";

@implementation LCLKGift06InputViewPlugin
...
+ (LCCKInputViewPluginType)classPluginType {
    return LCCKInputViewPluginType006;
}
