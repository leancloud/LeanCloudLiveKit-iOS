...
//    }
    self.videoCaptureConfigurations = @[
                                        [[PLVideoCaptureConfiguration alloc] initWithVideoFrameRate:15 sessionPreset:AVCaptureSessionPreset640x480 horizontallyMirrorFrontFacingCamera:YES horizontallyMirrorRearFacingCamera:NO
                                         cameraPosition:AVCaptureDevicePositionFront],
                                        [[PLVideoCaptureConfiguration alloc] initWithVideoFrameRate:24 sessionPreset:AVCaptureSessionPreset640x480 horizontallyMirrorFrontFacingCamera:YES horizontallyMirrorRearFacingCamera:NO cameraPosition:AVCaptureDevicePositionFront],
                                        [[PLVideoCaptureConfiguration alloc] initWithVideoFrameRate:30 sessionPreset:AVCaptureSessionPreset640x480 horizontallyMirrorFrontFacingCamera:YES horizontallyMirrorRearFacingCamera:NO cameraPosition:AVCaptureDevicePositionFront]
                                        ];
...
#warning 如果要运行 demo 这里应该填写服务端返回的某个流的 json 信息
    ...
    NSDictionary *streamJSON =  @{
                                  @"id" : @"chenyilonggithublivecode",
                                  @"title" : @"chenyilonggithublivecode",
                                  @"hub" : @"livekit",
                                  @"publishKey" : @"publish_key",
                                  ...
                                  @"hosts" : @{
                                          ...
                                          @"live" : @{
                                                  @"rtmp" : @"pili-publish.leancloud.cn",
                                                  },
                                          @"play" : @{
                                                  @"hdl" : @"pili-live-hdl.leancloud.cn",
                                                  @"hls" : @"pili-live-hls.leancloud.cn",
                                                  @"http" : @"pili-live-hls.leancloud.cn",
                                                  @"rtmp" :@"pili-live-rtmp.leancloud.cn",
                                                  @"snapshot":@"pili-live-snapshot.leancloud.cn",
                                                  },
                                          @"publish" : @{
                                                  @"rtmp" : @"pili-publish.leancloud.cn",
                                                  }
